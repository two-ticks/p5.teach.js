...
function writeAnimator(object, timeDuration, delayDuration) {
  // console.log(object);
  //object = object;
  // timeDuration = timeDuration; //seconds
  // delayDuration = delayDuration; //seconds
...
function eraseAnimator(object, timeDuration, delayDuration) {
  animationTimeline.add({
    targets: object.writeTextElement.elt.querySelectorAll('.letter'),
...
function dissolveAnimator(object, timeDuration, delayDuration) {
  animationTimeline.add({
    targets: object.writeTextElement.elt.querySelectorAll('.letter'),
...
function spinOutAnimator(object, timeDuration, delayDuration) {
...
function waveOutAnimator(object, timeDuration, delayDuration) {
  object.writeTextElement.elt.querySelectorAll('.letter').forEach(function (el) {
    return el.style.display = 'inline-block';
  }); //object.writeTextElement.style('overflow', 'hidden');
...
function waveInAnimator(object, timeDuration, delayDuration) {
  animationTimeline.add({
...
function fadeOutAnimator(object, timeDuration, delayDuration) {
  animationTimeline.add({
    targets: object.writeTextElement.elt.querySelectorAll('.letter'),
    //scale: [4, 1],
    opacity: [1, 0],
    //translateZ: 0,
    easing: 'easeInOutCubic',
    duration: timeDuration //delay: delayDuration
    //delay: anime.stagger(180, { start: timeDuration }) //time duration must be replaced with delay

  }, delayDuration);
}

function fadeInAnimator(object, timeDuration, delayDuration) {
  animationTimeline.add({
    targets: object.writeTextElement.elt.querySelectorAll('.letter'),
    //scale: [4, 1],
    opacity: [0, 1],
...
},{"../Scene/play":"lib/Scene/play.ts"}],"lib/Scene/scene.ts":[function(require,module,exports) {
"use strict";
...
},{"./lib/MObject/Text":"lib/MObject/Text.ts","./lib/Scene/add":"lib/Scene/add.ts","./lib/Scene/play":"lib/Scene/play.ts","./lib/Scene/scene":"lib/Scene/scene.ts"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
